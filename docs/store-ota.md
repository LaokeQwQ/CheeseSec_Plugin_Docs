...
本文是 CheeseSec 商店、OTA、资源端点和插件运行边界的双语手册。它描述可验收的发布元数据契约，不表示线上服务或安装器已经部署。发布仓库中的机器可读 schema 位于 CheeseSec_Plugin/schema/store-v1/，公开镜像使用 https://store.cheesesec.com/schema/store/v1/。
